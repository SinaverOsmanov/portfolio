...
function Navigation({ isOpen, setOpen }: { isOpen: boolean; setOpen: (payload: boolean) => void }) {
    ...
    return (
        <aside className="z-10">
            <button className="lg:hidden fixed right-5 top-5 z-20 p-3 rounded-lg" onClick={() => setOpen(!isOpen)}>
